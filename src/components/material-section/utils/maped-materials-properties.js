...
const mapedMaterialsProperties = {
  ...
  [materialsTypes.MESH_SHADER_MATERIAL]: [m.SHADERS, m.VERTEXCOLORS, m.SKINNING, m.SIDE, m.flatShading, m.BLENDING, m.OPACITY, m.TRANSPARENT, m.ALPHATEST, m.WIREFRAME]
};
